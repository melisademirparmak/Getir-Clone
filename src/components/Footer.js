...
const Footer = () => {
    ...
    return <div className="bg-white mt-10">
        <div className="container mx-auto px-4 md:px-0">
            <div className="grid gap-y-6 md:grid-cols-2 lg:grid-cols-3 pt-5 md:pt-10">
                ...
                {footerMenu &&
                footerMenu.map((footerMenu, key) => <FooterItem key={key} footerMenu={footerMenu}/>)}
            </div>
            <div
                className="flex flex-col md:flex-row gap-y-4 justify-between items-center border-t border-gray-200 mt-6 py-6">
                &copy; 2021 Getir
                <a
                    href="/"
